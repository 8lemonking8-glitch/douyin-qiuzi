...
从 0.9.1 起，安装包使用固定应用标识、固定当前用户安装目录和固定开始菜单目录。更新时只需：

1. 退出正在运行的“抖音英语答题助手”。
2. 双击新版 `抖音英语答题助手_x64-setup.exe`，直接按“安装”。

无需先卸载旧版本；题库选择、房间地址、答题规则和 Overlay 设置会保留。早期英文名称的历史测试版若仍显示在“已安装的应用”中，可单独卸载一次。
