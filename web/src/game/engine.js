...
export class QuizEngine {
  ...
  initialState() {
    return {
      ...
      stats: { A: 0, B: 0, C: 0, D: 0 }, answers: {}, players: {}, recent: [], winner: null,
      dycastConnected: 0, externalDycastConnected: 0, directDycastConnected: 0,
  ...
  snapshot() {
    ...
    return {
      ...
      externalDycastConnected: this.state.externalDycastConnected,
  ...
  setDycastStatus({ connected = 0, error = null } = {}) {
    this.state.externalDycastConnected = Number(connected) || 0;
    this.state.dycastConnected = this.state.externalDycastConnected + this.state.directDycastConnected;
    if (error) this.state.dycastError = error;
    else if (!this.state.directDycastConnecting && !this.state.directDycastConnected) this.state.dycastError = null;
    this.notify();
  }
